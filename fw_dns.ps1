...
## VNC
netsh adv f a r n=VNC-Server-TCP dir=in act=allow prof=any prot=tcp localport=5900
netsh adv f a r n=VNC-Server-UDP dir=in act=allow prof=any prot=udp localport=5900
